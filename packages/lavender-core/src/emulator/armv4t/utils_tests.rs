...
fn test_addressing_mode_1_immediate() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE3B0_0080);
...

    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE3B0_0102);
...

    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE3B0_0403);
...
fn test_addressing_mode_1_register() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0001);
...
fn test_addressing_mode_1_lsl_immediate() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0081);
...

    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0101);
...
fn test_addressing_mode_1_lsl_register() {
    {
        ...
        //   cond    opc  S Rn   Rd             Rm
        // 0b1110_0001_1011_0000_0000_0010_0001_0001 - movs r0,r1,lsl r2
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0211);
        assert_eq!(shifter_operand, 0xAABB_CCDD);
        assert_eq!(shifter_carry_out, true);
    }
...
fn test_addressing_mode_1_lsr_immediate() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0021);
        assert_eq!(shifter_operand, 0x0);
        assert_eq!(shifter_carry_out, true);
    }
...

    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_00A1);
...
fn test_addressing_mode_1_lsr_register() {
    {
        ...
        //   cond    opc  S Rn   Rd             Rm
        // 0b1110_0001_1011_0000_0000_0010_0011_0001 - movs r0,r1,lsr r2
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0231);
        assert_eq!(shifter_operand, 0xAABB_CCDD);
        assert_eq!(shifter_carry_out, true);
    }
...
fn test_addressing_mode_1_asr_immediate() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0041);
...

    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0141);
        assert_eq!(shifter_operand, 0x1);
        assert_eq!(shifter_carry_out, true);
    }

    {
        ...
        //   cond    opc  S Rn   Rd             Rm
        // 0b1110_0001_1011_0000_0000_0000_1100_0001 - movs r0,r1,asr 0x1
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_00C1);
        assert_eq!(shifter_operand, 0xFFFF_FFFF);
        assert_eq!(shifter_carry_out, false);
    }
}
...
fn test_addressing_mode_1_asr_register() {
    {
        ...
        //   cond    opc  S Rn   Rd             Rm
        // 0b1110_0001_1011_0000_0000_0010_0101_0001 - movs r0,r1,asr r2
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0251);
        assert_eq!(shifter_operand, 0xAABB_CCDD);
        assert_eq!(shifter_carry_out, true);
    }
...
fn test_addressing_mode_1_ror_immediate() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_00E1);
        assert_eq!(shifter_operand, 0x8000_0000);
        assert_eq!(shifter_carry_out, true);
    }
...
fn test_addressing_mode_1_ror_register() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0271);
        assert_eq!(shifter_operand, 0xAABB_CCDD);
        assert_eq!(shifter_carry_out, true);
    }
...
fn test_addressing_mode_1_rrx() {
    {
        ...
        let (shifter_operand, shifter_carry_out) =
            process_shifter_operand_tmp(&mut emulator, 0xE1B0_0061);
        assert_eq!(shifter_operand, 0x8000_0001);
        assert_eq!(shifter_carry_out, true);
    }
